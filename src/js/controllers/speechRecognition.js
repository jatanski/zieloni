    ...
    static captureSpeech(validator, game, mic_icon, setNewRoundSchema) {
        ...
        return new Promise((resolve, reject) => {
            ...
            recognition.addEventListener('result', e => {
                ...
                mic_icon.parentNode.parentNode.children[3].innerHTML = transcript;//informuje w którym miejscu masz wrzucić to, co się powiedziało 
            ...
            recognition.start();
            setTimeout(() => { mic_icon.parentNode.parentNode.children[3].innerHTML = 'zacznij mówić' }, 750)
